...
export type SSOProvider = "google" | "microsoft" | "github" | "gitlab" | "bitbucket";
...
export const SSOButton: React.FC<SSOButtonProps> = ({ provider, children, fullWidth = false, className, ...props }) => {
  const config = providerConfig[provider];

  return (
    <button className={clsx(styles.ssoButton, styles[provider], { [styles.fullWidth]: fullWidth }, className)} {...props}>
