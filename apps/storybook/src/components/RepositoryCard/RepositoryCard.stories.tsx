...
export const LongDescription: Story = {
  args: {
    ...
    description: 'This is a very long description that will be truncated after two lines to maintain a consistent card height across all repository cards in the list view',
    language: 'Rust',
