        ...
        return (
          <div>
            ...
            <p style={{ marginBottom: '2rem', color: '#718096' }}>
              Select the version control systems you want to connect
            </p>
      ...
      case 3:
        return (
          <div>
            ...
            <p style={{ marginBottom: '2rem', color: '#718096' }}>
              We'll help you organize your repositories into teams
            </p>
            <Card
              icon="🔍"
              title="Repository Discovery"
              description="We found 23 repositories across your connected data sources"
              variant="gradient"
            />
          </div>
        );
